...
const MobiletopNav = () => {
  return (
    <div className="lg:hidden flex fixed justify-between bg-cover items-center top-0 left-0 w-screen h-[64px] bg-[url('/backg.avif')] bg-white  border-b-[1px] border-solid border-b-slate-400 ">
      <div className="ml-2">
